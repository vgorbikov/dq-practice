...
client {
    ...
    registration_dttm timestamptz "Дата регистрации клиента"
}
...
product {
    ...
    price_currency text FK "Dалюта, в которой указана цена"
}

currency {
    currency_code text PK "Буквенный код валюты"
...
order {
    ...
    total_price_currency text FK "Ссылка на валюту"
...
pick_ip_point_address {
    ...
    country text "Страна нахождения"
    region text "Регион"
    city text "Город" 
    street text "Название улицы"
    house text "Номер дома"
...
product {
    ...
    price_value int "Цена продукта"
    price_currency text FK "Ссылка на валюту цены"
}
